    ...
    <div className={classes.root}>
      ...
      >
        <div className={classes.row}>
          <InputLabel htmlFor="outlined-name">Company</InputLabel>
          <Badge
            aria-describedby={id}
            size="small"
            overlap="circular"
        ...
        <div className={classes.row}>
          ...
          <FormControl sx={{ m: 1, width: "9.5rem" }} variant="outlined">
            ...
            />
            <FormHelperText id="outlined-retention-helper-text">
              Employee retention
            </FormHelperText>
          </FormControl>
          <FormControl sx={{ m: 1, width: "9.5rem" }} variant="outlined">
            <OutlinedInput
              ...
              // onChange={handleChange("weight")}
              endAdornment={
                <InputAdornment position="end">% female</InputAdornment>
              }
            ...
            />
            <FormHelperText id="outlined-gender-helper-text">
              Gender distribution
            </FormHelperText>
          </FormControl>
        </div>
